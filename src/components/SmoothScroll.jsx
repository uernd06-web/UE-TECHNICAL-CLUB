...
'use client';
import * as LenisModule from 'lenis/react';

export default function SmoothScroll({ children }) {
  // Turbopack / Next.js compatibility check
  const LenisComponent = LenisModule.ReactLenis || LenisModule.default || LenisModule;
