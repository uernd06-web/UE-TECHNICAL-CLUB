  ...
  const navItems = [
    ...
    { name: "CERTIFICATION", path: "/pages/certification" },
    {
      ...
      dropdown: [
        ...
        { name: "ONLAB", description: "Hands-on practical learning", path: "/pages/programs/onlab" },
      ],
    },
    {
      name: "ADMINISTRATION",
      dropdown: [
        ...
        { name: "TRAINING DEPARTMENT", description: "Management, trainers and mentors", path: "/pages/administration/training-department" },
      ],
    },
    {
      name: "COMMUNITY",
    ...
    <header className="fixed top-0 left-0 w-full z-50 transition-all duration-300 font-sans">
        ...
        <div className="flex items-center gap-2">
          <span
            className={`h-2.5 w-2.5 rounded-full inline-block ${
              isScrolled ? "bg-red-700" : "bg-yellow-400"
            }`}
          ></span>
      ...
      <nav
        style={
          !isScrolled
            ? {
                backgroundColor: "rgba(0, 0, 0, 0.15)", // হালকা ব্ল্যাকিশ ওভারলে, যেন লেখাগুলো স্পষ্ট থাকে
      ...
      {mobileMenuOpen && (
        <div
          className={`lg:hidden border-t px-4 pt-2 pb-6 space-y-1 transition-all duration-300 ${
            isScrolled
